    ...
    <div class="home">
        ...
        <div class="banner">
			<el-carousel indicator-position="outside" height="480px">
			    <el-carousel-item v-for="item in banner" :key="item.id">
				  ...
				  <img v-if="item.picUrl2" class="img2 b" :src="item.picUrl2"/>
				  <img v-if="item.picUrl3" class="img3 c" :src="item.picUrl3"/>
			    </el-carousel-item>
			 </el-carousel>
		</div>
		<div v-for="item in homeList" :key="item.id">
			<div class="activity-panel" v-if="item.type === 1">
				<!-- 仅仅要活动版块的内容 -->
				<el-row>
				  <el-col class="content" :span="8" v-for="(o, index) in item.panelContents" :key="o.id">
			...
			<section class="w mt30 clearfix" v-if="item.type === 2">
				<m-shelf :title='item.name'>
					<div slot='content' class="hot">
						<mail-goods v-for="(o, i) in item.panelContents" :key="i" :goods='o'></mail-goods>
					</div>
				</m-shelf>
			</section>
			<section class="w mt30 clearfix" v-if="item.type === 3">
				<m-shelf :title='item.name'>
					<div slot='content' class="floors">
						<div class="imgbanner" v-for="(o, i) in item.panelContents" :goods= 'o' :key='i' v-if="o.type===2 || o.type===3">
							<img :src="o.picUrl"/>
						</div>
						<mail-goods v-for="(o, j) in item.panelContents" :key='j' :goods='o' v-if="o.type===0"></mail-goods>
					</div>
				</m-shelf>
			</section>
		</div>

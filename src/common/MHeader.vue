    ...
    <div>
      <header class="w">
        <div class="w-box">
          ...
          <div class="right-box">
            <div class="nav-list">
				<el-input placeholder="请输入商品信息" suffix-icon="el-icon-search" v-model="productInfo"> </el-input>
				<router-link to="/goods">全部商品</router-link>
				<router-link to="/thanks">捐赠名单</router-link>
			</div>
			<div class="nav-aside">
              <!-- 用户 -->
              <div class="user pr">
                          ...
                          <li class="clearfix" v-for="(goods, index) in cartList" :key="index">
                            <div class="cart-item">
                              <div class="cart-item-inner">
                                ...
                                <div class="del-btn del" @click="deleteGoods(index)">删除</div>
                              </div>
                            </div>
                          </li>
                        </ul>
...
export default {
    ...
    methods:{
	    ...mapMutations(['SHOWCART', 'INITBUYCART', 'DELETECART']),
		cart(){
			this.$router.push({
				path: '/cart'
			})
